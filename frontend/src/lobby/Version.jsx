...
const Version = ({version, MTGJSONVersion, boosterRulesVersion}) => {
  return (
    <div className="Version">
      <div>
        <a href="https://github.com/dr4fters/dr4ft" title='dr4ft Project'>dr4ft</a> {" "}
      ...
      <div>
        <a href="https://www.mtgjson.com" title='Card Data Source'>MTGJSON</a> {" "}
      ...
      <div>
        {" "}
        <a href={"https://github.com/taw/magic-sealed-data"} title='Booster Rules Source'>Magic Sealed Data</a> {" "}
